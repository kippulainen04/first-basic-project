...
**Build an app that is functionally similar to [this](https://tribute-page.freecodecamp.rocks/)**
...
* Then add [this link](https://kippulainen04.github.io/first-basic-project/) to your internet browser
...
* [Reference Project](https://tribute-page.freecodecamp.rocks/)
* [Content](https://en.wikipedia.org/wiki/John_D._Rockefeller#Bibliography)
